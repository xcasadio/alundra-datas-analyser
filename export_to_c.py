...
prefixes_to_exclude = [
     "_", "BIOS_", "Cd", "CD_", "EVENT_", "EXT_", "FONT_", "GPU_", "INTR_", "ISO9660_", 
    "Krom2RawAdd", "MEM", "PAD", "PRNT_", "PUT", "S_", "SPRINTF_", 
    "SPU_", "SR_", "STR", "SYS_", "Spu", "Ss", "VSYNC", "gte_", "v_", "get_", "def_",
...
contains_to_exclude = ["Intr", "DispEnv", "DrawEnv", "OTag", "Sync", "Graph"]
