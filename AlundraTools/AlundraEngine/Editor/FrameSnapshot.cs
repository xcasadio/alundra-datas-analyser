...
public class FrameSnapshot
{
    ...
    public void CopyToMemory()
    {
        ...
        StaticVariables.g_hudDeltaX = CameraDeltaX;
        StaticVariables.g_hudDeltaY = CameraDeltaY;
        //StaticVariables.g_hudCurrentX = CameraCurrentX;
        //StaticVariables.g_hudCurrentY = CameraCurrentY;
        StaticVariables.g_hudX = CameraX;
        StaticVariables.g_hudY = CameraY;
    ...
    public void CopyFromMemory()
    {
        ...
        CameraDeltaX = StaticVariables.g_hudDeltaX;
        CameraDeltaY = StaticVariables.g_hudDeltaY;
        CameraCurrentX = StaticVariables.g_hudCurrentX;
        CameraCurrentY = StaticVariables.g_hudCurrentY;
        CameraX = StaticVariables.g_hudX;
        CameraY = StaticVariables.g_hudY;
