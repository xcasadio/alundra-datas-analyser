...
public class EventCodeDebugger
{
    ...
    public static readonly Dictionary<byte, CommandInfo> CommandPropertiesByCode = new()
    {
        ...
        {0x28, new(0x28, 1, "Set EntityFlags.ClassB", nameof(EntityEventHandlers.Script_40_028)) },
        {0x29, new(0x29, 1, "Clear EntityFlags.ClassB", nameof(EntityEventHandlers.Script_41_029)) },
        {0x2A, new(0x2A, 1, "Set EntityFlags.ClassA", nameof(EntityEventHandlers.Script_42_02A)) },
        {0x2B, new(0x2B, 1, "Clear EntityFlags.ClassA", nameof(EntityEventHandlers.Script_43_02B)) },
        ...
        {0x35, new(0x35, 3, "Wait flag on", nameof(EntityEventHandlers.Script_53_035)) },
        {0x36, new(0x36, 3, "Wait flag off", nameof(EntityEventHandlers.Script_54_036)) },
        ...
        {0x45, new(0x45, 1, "Clear EntityFlags.NoObstacleSlide", nameof(EntityEventHandlers.Script_69_045)) },
        {0x46, new(0x46, 1, "Set EntityFlags.NoObstacleSlide", nameof(EntityEventHandlers.Script_70_046)) },
        ...
        {0x62, new(0x62, 4, "Set entities flags (low 16 bits)", nameof(EntityEventHandlers.Script_98_062)) },
        {0x63, new(0x63, 4, "Clear entities flags (low 16 bits)", nameof(EntityEventHandlers.Script_99_063)) },
        ...
        {0x80, new(0x80, 3, "Jump from param if flag set", nameof(EntityEventHandlers.Script_JumpFromStoredParamIfFlagSet_080)) },
        {0x81, new(0x81, 3, "Jump from param if flag clear", nameof(EntityEventHandlers.Script_JumpFromStoredParamIfFlagClear_081)) },
        ...
        {0xAC, new(0xAC, 4, "Set entity shadow size", nameof(EntityEventHandlers.Script_172_0AC)) },
